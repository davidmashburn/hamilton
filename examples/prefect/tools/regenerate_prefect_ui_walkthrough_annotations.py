...
LEGACY_COORDS = {
    ...
    "flow-run-success-detail-annotated": [
        {
            ...
            "line_anchor": "top-center",
            "line_anchor_perimeter": False,
            "edge_refine": False,
        },
        {
            "text": "Task Gantt bars for execution",
            "box_css": [600, 232, 340, 104],
            "label_css": [980, 172],
            "line_anchor": "center",
            "line_anchor_perimeter": False,
            "edge_refine": False,
        ...
        {
            "text": "Switch tabs: logs, task runs, params",
            "selector": "ul.p-tab-navigation[role='tablist']",
            "label_css": [860, 440],
            "line_anchor": "top-center",
            "line_anchor_perimeter": False,
            "edge_refine": False,
        ...
        {
            "text": "Logs show retries and transitions",
            "box_css": [206, 542, 1008, 324],
            "label_css": [520, 462],
            "line_anchor": "top-center",
            "line_anchor_perimeter": False,
            "edge_refine": False,
    ...
    "flow-run-failed-detail-annotated": [
        ...
        {
            "text": "Failed task highlighted in red",
            "box_css": [665, 286, 280, 60],
            "label_css": [984, 252],
            "line_anchor": "center",
            "line_anchor_perimeter": False,
            "edge_refine": False,
        ...
        {
            "text": "Failure logs + retry exhaustion details",
            "box_css": [206, 542, 1008, 324],
            "label_css": [514, 462],
            "line_anchor": "top-center",
            "line_anchor_perimeter": False,
